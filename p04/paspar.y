...
program_head: PROGRAM ID program_parameters SEMICOLON
  {
    o << "#002 program_head -> PROGRAM ID(" << (*$2) << ") program_parameters ;" << endl;
    program_head(*$2);
  }
...
variable_declarations: variable_declarations VAR identifier_list COLON type SEMICOLON
  {
...
subprogram_head: PROCEDURE ID subprogram_parameters SEMICOLON
  {
    o << "#019 subprogram_head -> PROCDURE ID(" << (*$2) << ") subprogram_parameters ;" << endl;
    subprogram_head(*$2,$3);
  } 
