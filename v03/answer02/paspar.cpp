...
{
       0,    91,    91,    95,    99,   103,   107,   110,   114,   118,
     122,   126,   129,   133,   137,   141,   145,   148,   152,   156,
     160,   164,   167,   171,   175,   179,   183,   186,   190,   194,
...
/* Line 1806 of yacc.c  */
#line 161 "paspar.y"
    {tfs << endl << "#019 subprogram_head -> PROCDURE ID subprogram_parameters ;";
  }
    break;
...
/* Line 1806 of yacc.c  */
#line 227 "paspar.y"
    {tfs << endl << "#036 procedure_statement -> ID "; 
  }
    break;
...
/* Line 1806 of yacc.c  */
#line 231 "paspar.y"
    {tfs << endl << "#037 procedure_statement -> ID ( expression_list )"; 
  }
    break;
...
/* Line 1806 of yacc.c  */
#line 339 "paspar.y"
    {tfs << endl << "#064 factor -> ID [ expression ]"; 
  }
    break;
...
/* Line 1806 of yacc.c  */
#line 343 "paspar.y"
    {tfs << endl << "#065 factor -> ID ( expression_list )"; 
  }
    break;
