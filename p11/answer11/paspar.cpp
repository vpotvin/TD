...
//---------------------------------------------------------------------
//Version 11: subprogram_head, subprogram_declaration program_body 
//---------------------------------------------------------------------
...
{
       0,   175,   175,   180,   185,   189,   194,   197,   201,   205,
     210,   215,   218,   223,   228,   233,   238,   241,   245,   250,
     255,   260,   264,   269,   274,   279,   284,   288,   293,   298,
     303,   308,   313,   318,   323,   328,   333,   338,   343,   348,
     353,   358,   363,   368,   372,   376,   380,   384,   388,   392,
     397,   402,   407,   411,   415,   419,   423,   427,   432,   437,
     441,   445,   449,   453,   457,   462,   467,   472,   477,   482,
     487,   492
};
#endif
...
#line 176 "paspar.y"
   ...
   program((yyvsp[(1) - (3)].subprog),(yyvsp[(3) - (3)].explist));             //program semantics
  }
    break;
...
#line 181 "paspar.y"
   ...
   (yyval.subprog)=program_head(*(yyvsp[(2) - (4)].token));
  }
    break;
...
#line 190 "paspar.y"
  ...
  (yyval.explist)=Program_body((yyvsp[(1) - (2)].explist));
  }
    break;
...
#line 246 "paspar.y"
   ...
   subprogram_declaration((yyvsp[(1) - (3)].subprog),(yyvsp[(3) - (3)].explist));
  }
    break;
...
#line 251 "paspar.y"
   ...
   (yyval.subprog)=subprogram_head(*(yyvsp[(2) - (6)].token),(yyvsp[(3) - (6)].varlist),(yyvsp[(5) - (6)].typ));
  }
    break;
...
#line 256 "paspar.y"
   ...
   (yyval.subprog)=subprogram_head(*(yyvsp[(2) - (4)].token),(yyvsp[(3) - (4)].varlist));
  }
    break;
